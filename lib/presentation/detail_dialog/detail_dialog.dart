...
//                   children: [
//                     imageSection(currentFeed),
//                     actionBar(isLiked, currentUser, isMe, context),
//                     contentSection(currentFeed),
//                   ],
//                 ),
//               ),
//             ),
...
//   Widget contentSection(FeedEntity currentFeed) {
//     if (isEditing) {
//       return TextField(
...
//         child: Text(currentFeed.content, style: const TextStyle(fontSize: 14)),
//       );
//     }
//   }
...
//               }
//             });
//             await ref.read(likeUsecaseProvider).like(currentUser, widget.feed);
//           },
//         ),
...
//           },
//         ),
//         if (isMe && !isEditing) ...[const Spacer(), editAndDelete(context)],
//       ],
//     );
//   }

//   AspectRatio imageSection(FeedEntity currentFeed) {
//     return AspectRatio(
//       aspectRatio: 0.8,
//       child: Stack(
//         children: [
...
//                     .updateFeed(
//                       widget.feed.copyWith(content: _contentController.text),
//                       selectedImage,
//                     );
//                 setState(() {
//                   selectedImage = null;
